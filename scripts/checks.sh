...
files=`find . -name "*.cpp" -or -name "*.hpp" -or -name ".h" | grep -v "./tools/*" | grep -v "./cmake-build-debug/CMakeFiles/3.16.5/CompilerIdCXX/CMakeCXXCompilerId.cpp" | grep -v "./tests" | grep -v "./include/PicoSHA2/" | grep -v "./cmake-build-debug/_3rdParty/Hunter/toolchain/_builds/CMakeFiles/3.16.5/CompilerIdCXX/CMakeCXXCompilerId.cpp"`
